...
<div
    ...
    x-show="show"
    class="fixed inset-0 overflow-y-auto px-6 py-4 sm:px-0 z-50"
    style="display: {{ $show ? 'block' : 'none' }};"
>
    {{-- Backdrop --}}
    <div
        x-show="show"
        class="fixed inset-0 transform transition-all bg-black opacity-40"
    ...
    >
        ...
        <div class="flex justify-between">
            ...
            <button x-on:click="show = false" class="text-darkGray hover:text-gray">
