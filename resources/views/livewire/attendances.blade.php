            ...
            <div class="flex justify-end ps-2">
                <x-dropdown align="right" menuWidth="100%" isFilter="true">
                    ...
                    <div class="flex justify-end items-center space-x-4">
                        <x-button
                            href="{{ route('export_attendance_pdf', ['search' => $search, 'selectedPosts' => $selectedPosts, 'selectedStatuses' => $selectedStatuses, 'startDate' => $startDate, 'endDate' => $endDate]) }}"
                            btnType="success" element="a" textSize="text-xs" class="flex space-x-2 items-center"
                            target="_blank">
                            <span>Print</span>
                        </x-button>
                    </div>
