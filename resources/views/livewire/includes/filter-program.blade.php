<div>
   <x-dropdown align="left" menuWidth="44" isFilter="true">
      ...
      @slot('content')
         <x-accordion
         class="filter-accordion transition-all rounded-lg"
            name="program-accordion">
            @foreach ($colleges as $college)
               <x-accordion-item itemId="{{ $college->id }}" headerClasses="hover:bg-lightGray"
                  contentClasses="bg-lightGray" :showIndicator="true">
                  @slot('header')
