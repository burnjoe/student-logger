<div>
    ...
    <div class="flex flex-wrap px-5 pb-5 pt-2.5">
        ...
        <div class="w-full md:w-1/2">
            ...
            <small class="font-normal text-darkGray pt-2.5" style="font-size: 65%;">Guardian's Contact
                Number</small>
    ...
    <div class="flex flex-wrap px-5 pb-5 pt-2.5">
        ...
        <div class="w-full md:w-1/2">
            <small class="font-normal text-darkGray pt-2.5" style="font-size: 65%;">Learner Reference Number
                (LRN)</small>
