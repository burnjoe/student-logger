            ...
            <div>
                ...
                <x-table class="mt-4 z-0">
                    ...
                    <tr wire:key="{{ $attendance->id }}"
                        ...
                        <td class="px-6 py-4">{{ \Carbon\Carbon::parse($attendance->logged_in_at)->format('h:i A') }}
                        </td>
                        <td class="px-6 py-4">
                ...
                <div class="w-full md:w-3/4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-row justify-between mt-4">
                            ...
                            <div class="flex">
                                <x-button
                                    href="{{ route('export_library_pdf', ['monthYear' => $selectMonthYearLibrary]) }}"
                                    onclick="generatePDF()" element="a" btnType="primary" textSize="text-xs"
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-col w-full md:w-1/2">
                            ...
                            <x-input-text id="selectMonthYearClinic" wire:model.live.defer="selectMonthYearClinic"
                                name="selectMonthYearClinic" type="month" class="w-full mt-1 bg-lightGray"
                                :messages="$errors->get('selectMonthYearClinic')" />
                        </div>
                        ...
                        <div class="flex flex-row justify-between mt-4">
                            ...
                            <div class="flex">
                                <x-button
                                    href="{{ route('export_clinic_pdf', ['monthYear' => $selectMonthYearClinic]) }}"
                                    element="a" btnType="primary" textSize="text-xs" class="flex space-x-2 items-center"
                                    target="_blank">
                                    <i class="fa-solid fa-print"></i>
                                    <span>Print</span>
